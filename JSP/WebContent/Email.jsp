...
<div id="navbar">
			...
			<div id=email>
<form name="email" method="post" action="email">
<table>
<tr>
Message to <%out.println(((UserData)session.getAttribute("usermail")).getFirstname()+" "+((UserData)session.getAttribute("usermail")).getLastname());%>
<tr>
<tr>
<td>Message:</td><td><INPUT TYPE=TEXT NAME=message SIZE=20></td>
</tr>
</table>
