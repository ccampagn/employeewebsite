...
<%@ page import="java.util.*,user.UserData,user.WorkInfo,user.UserData,user.ShiftInfo,user.Break,user.Shift;" %>
<html>
<head>
...
<form name="Editshifttimechange" method="post" action="changepoints">
<table>
<tr><td>Points:</td><td> <input type="text" name="points" value="<%=(((Integer)session.getAttribute("editpoints")))%>" ></td></tr>
