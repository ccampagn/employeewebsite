...
<div id="messagereply">
<form name="messagerepling" method="post" action="messagerepling">
<table>
<tr><td>Name:</td><td><%out.print(((Message)session.getAttribute("message")).getFirstname()+" "+((Message)session.getAttribute("message")).getLastname()); %></td></tr>
